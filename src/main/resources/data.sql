INSERT INTO agents (id, name, status, active_order_count, current_zone, max_capacity, created_at, updated_at) VALUES
...
INSERT INTO orders (id, description, assigned_agent_id, status, pickup_zone, dropoff_zone, weight_class, priority, created_at, updated_at) VALUES
